...
echo "n=16 size=1000">>logfile
 (time mp1irun mpi 1000 3 28 -n 16|tail -3)2>>logfile
...
echo "n=4 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 4|tail -3)2>>logfile
echo "n=6 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 6|tail -3)2>>logfile
echo "n=10 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 10|tail -3)2>>logfile
echo "n=12 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 12|tail -3)2>>logfile
echo "n=16 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 16|tail -3)2>>logfile
echo "n=18 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 18|tail -3)2>>logfile
echo "n=20 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 20|tail -3)2>>logfile
echo "n=26 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 26|tail -3)2>>logfile
echo "n=30 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 30|tail -3)2>>logfile
echo "n=34 size=150000">>logfile
 (time mpirun mpi 150000 3 28 -n 34|tail -3)2>>logfile
echo "n=4 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 4|tail -3)2>>logfile
echo "n=6 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 6|tail -3)2>>logfile
echo "n=10 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 10|tail -3)2>>logfile
echo "n=12 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 12|tail -3)2>>logfile
echo "n=16 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 16|tail -3)2>>logfile
echo "n=18 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 18|tail -3)2>>logfile
echo "n=20 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 20|tail -3)2>>logfile
echo "n=26 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 26|tail -3)2>>logfile
echo "n=30 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 30|tail -3)2>>logfile
echo "n=34 size=200000">>logfile
 (time mpirun mpi 200000 3 28 -n 34|tail -3)2>>logfile
